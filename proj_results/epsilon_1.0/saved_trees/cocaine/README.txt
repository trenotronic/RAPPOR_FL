...
-------------------------------------------
Baseline F1:      0.0689
RAPPOR-only F1:   0.0372
RAPPOR + DP-seg:  0.0402

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0317
  • DPseg  - Baseline: -0.0287

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.0691
RAPPOR-only logreg F1:   0.0373
RAPPOR + DP-seg logreg:  0.0391

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0318
  • DPseg  - Baseline: -0.0300
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.1410
  DP-seg / Baseline: 0.0058
