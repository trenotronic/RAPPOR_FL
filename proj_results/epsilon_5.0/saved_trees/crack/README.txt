...
-------------------------------------------
Baseline F1:      0.0125
RAPPOR-only F1:   0.0066
RAPPOR + DP-seg:  0.0049

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0059
  • DPseg  - Baseline: -0.0076

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.0127
RAPPOR-only logreg F1:   0.0066
RAPPOR + DP-seg logreg:  0.0049

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0061
  • DPseg  - Baseline: -0.0077
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.3432
  DP-seg / Baseline: 0.0278
