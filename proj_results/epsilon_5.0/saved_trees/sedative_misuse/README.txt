...
-------------------------------------------
Baseline F1:      0.1228
RAPPOR-only F1:   0.0797
RAPPOR + DP-seg:  0.0777

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0430
  • DPseg  - Baseline: -0.0451

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.1230
RAPPOR-only logreg F1:   0.0800
RAPPOR + DP-seg logreg:  0.0751

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0430
  • DPseg  - Baseline: -0.0480
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.1603
  DP-seg / Baseline: 0.0084
