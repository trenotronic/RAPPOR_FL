...
-------------------------------------------
Baseline F1:      0.1954
RAPPOR-only F1:   0.1371
RAPPOR + DP-seg:  0.1364

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0583
  • DPseg  - Baseline: -0.0590

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.1956
RAPPOR-only logreg F1:   0.1365
RAPPOR + DP-seg logreg:  0.1364

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0592
  • DPseg  - Baseline: -0.0592
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.1067
  DP-seg / Baseline: 0.0063
