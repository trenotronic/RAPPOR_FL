...
RAPPOR + DP-seg:  0.3530

F1 deltas (tree):
  • RAPPOR - Baseline: -0.3668
  • DPseg  - Baseline: -0.0192

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.3907
RAPPOR-only logreg F1:   0.3081
RAPPOR + DP-seg logreg:  0.3240

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0826
  • DPseg  - Baseline: -0.0667
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.0787
  DP-seg / Baseline: 0.0049
