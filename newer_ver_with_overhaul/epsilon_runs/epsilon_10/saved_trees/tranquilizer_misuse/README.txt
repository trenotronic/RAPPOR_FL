...
-------------------------------------------
Baseline F1:      0.1274
RAPPOR-only F1:   0.1793
RAPPOR + DP-seg:  0.1758

F1 deltas (tree):
  • RAPPOR - Baseline: 0.0519
  • DPseg  - Baseline: 0.0484

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.2546
RAPPOR-only logreg F1:   0.1617
RAPPOR + DP-seg logreg:  0.1651

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0929
  • DPseg  - Baseline: -0.0895
