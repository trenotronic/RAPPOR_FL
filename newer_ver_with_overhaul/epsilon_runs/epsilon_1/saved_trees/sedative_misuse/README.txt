...
-------------------------------------------
Baseline F1:      0.1134
RAPPOR-only F1:   0.0150
RAPPOR + DP-seg:  0.0754

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0984
  • DPseg  - Baseline: -0.0380

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.1230
RAPPOR-only logreg F1:   0.0752
RAPPOR + DP-seg logreg:  0.0801

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0479
  • DPseg  - Baseline: -0.0430
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.1337
  DP-seg / Baseline: 0.0118
