...
-------------------------------------------
Baseline F1:      0.0265
RAPPOR-only F1:   0.0248
RAPPOR + DP-seg:  0.0254

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0018
  • DPseg  - Baseline: -0.0011

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.0400
RAPPOR-only logreg F1:   0.0238
RAPPOR + DP-seg logreg:  0.0255

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0162
  • DPseg  - Baseline: -0.0144
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.2880
  DP-seg / Baseline: 0.0185
