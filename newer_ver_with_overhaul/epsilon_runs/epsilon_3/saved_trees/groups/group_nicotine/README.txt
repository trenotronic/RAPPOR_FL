...
-------------------------------------------
Baseline F1:      0.4378
RAPPOR-only F1:   0.4119
RAPPOR + DP-seg:  0.4022

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0259
  • DPseg  - Baseline: -0.0355

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.4971
RAPPOR-only logreg F1:   0.3477
RAPPOR + DP-seg logreg:  0.3404

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.1494
