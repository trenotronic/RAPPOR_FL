...
-------------------------------------------
Baseline F1:      0.0424
RAPPOR-only F1:   0.0379
RAPPOR + DP-seg:  0.0373

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0045
  • DPseg  - Baseline: -0.0051

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.0691
RAPPOR-only logreg F1:   0.0384
RAPPOR + DP-seg logreg:  0.0362

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0306
  • DPseg  - Baseline: -0.0329
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.1619
  DP-seg / Baseline: 0.0066
