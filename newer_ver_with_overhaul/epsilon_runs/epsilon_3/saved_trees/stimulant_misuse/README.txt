...
-------------------------------------------
Baseline F1:      0.1108
RAPPOR-only F1:   0.1475
RAPPOR + DP-seg:  0.0503

F1 deltas (tree):
  • RAPPOR - Baseline: 0.0367
  • DPseg  - Baseline: -0.0605

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.1956
RAPPOR-only logreg F1:   0.1362
RAPPOR + DP-seg logreg:  0.1396

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0595
  • DPseg  - Baseline: -0.0560
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.0928
  DP-seg / Baseline: 0.0045
