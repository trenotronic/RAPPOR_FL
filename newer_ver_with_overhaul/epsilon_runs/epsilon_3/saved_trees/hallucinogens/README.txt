...
-------------------------------------------
Baseline F1:      0.0785
RAPPOR-only F1:   0.0121
RAPPOR + DP-seg:  0.0719

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0664
  • DPseg  - Baseline: -0.0066

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.1219
RAPPOR-only logreg F1:   0.0714
RAPPOR + DP-seg logreg:  0.0685

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0505
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.1225
  DP-seg / Baseline: 0.0079
