...
-------------------------------------------
Baseline F1:      0.3025
RAPPOR-only F1:   0.0143
RAPPOR + DP-seg:  0.2777

F1 deltas (tree):
  • RAPPOR - Baseline: -0.2882
  • DPseg  - Baseline: -0.0248

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.4019
RAPPOR-only logreg F1:   0.2422
RAPPOR + DP-seg logreg:  0.2496

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.1596
  • DPseg  - Baseline: -0.1523
