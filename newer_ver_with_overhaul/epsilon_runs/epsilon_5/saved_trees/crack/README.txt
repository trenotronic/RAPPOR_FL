...
-------------------------------------------
Baseline F1:      0.0065
RAPPOR-only F1:   0.0116
RAPPOR + DP-seg:  0.0071

F1 deltas (tree):
  • RAPPOR - Baseline: 0.0050
  • DPseg  - Baseline: 0.0006

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.0127
RAPPOR-only logreg F1:   0.0056
RAPPOR + DP-seg logreg:  0.0058

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0071
  • DPseg  - Baseline: -0.0069
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.3431
  DP-seg / Baseline: 0.0161
