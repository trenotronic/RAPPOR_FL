...
-------------------------------------------
Baseline F1:      0.0689
RAPPOR-only F1:   0.0370
RAPPOR + DP-seg:  0.0378

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0319
  • DPseg  - Baseline: -0.0312

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.0691
RAPPOR-only logreg F1:   0.0372
RAPPOR + DP-seg logreg:  0.0378

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0319
  • DPseg  - Baseline: -0.0313
