...
-------------------------------------------
Baseline F1:      0.2546
RAPPOR-only F1:   0.1639
RAPPOR + DP-seg:  0.1673

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0907
  • DPseg  - Baseline: -0.0872

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.2546
RAPPOR-only logreg F1:   0.1630
RAPPOR + DP-seg logreg:  0.1673

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0915
  • DPseg  - Baseline: -0.0872
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.0577
  DP-seg / Baseline: 0.0041
