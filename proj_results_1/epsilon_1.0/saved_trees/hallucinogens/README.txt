...
-------------------------------------------
Baseline F1:      0.1221
RAPPOR-only F1:   0.0667
RAPPOR + DP-seg:  0.0681

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0553
  • DPseg  - Baseline: -0.0539

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.1219
RAPPOR-only logreg F1:   0.0664
RAPPOR + DP-seg logreg:  0.0681

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0555
  • DPseg  - Baseline: -0.0537
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.0951
  DP-seg / Baseline: 0.0028
