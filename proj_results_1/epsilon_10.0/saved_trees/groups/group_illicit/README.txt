...
-------------------------------------------
Baseline F1:      0.4670
RAPPOR-only F1:   0.3309
RAPPOR + DP-seg:  0.3434

F1 deltas (tree):
  • RAPPOR - Baseline: -0.1362
  • DPseg  - Baseline: -0.1237

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.4670
RAPPOR-only logreg F1:   0.3305
RAPPOR + DP-seg logreg:  0.3434

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.1366
  • DPseg  - Baseline: -0.1237
