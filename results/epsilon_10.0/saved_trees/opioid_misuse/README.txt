...
-------------------------------------------
Baseline F1:      0.3894
RAPPOR-only F1:   0.3086
RAPPOR + DP-seg:  0.3000

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0808
  • DPseg  - Baseline: -0.0894

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.3907
RAPPOR-only logreg F1:   0.3097
RAPPOR + DP-seg logreg:  0.3000

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0809
  • DPseg  - Baseline: -0.0907
