...
-------------------------------------------
Baseline F1:      0.2546
RAPPOR-only F1:   0.1620
RAPPOR + DP-seg:  0.1717

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0926
  • DPseg  - Baseline: -0.0829

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.2546
RAPPOR-only logreg F1:   0.1621
RAPPOR + DP-seg logreg:  0.1717

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0925
  • DPseg  - Baseline: -0.0829
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.0564
  DP-seg / Baseline: 0.0047
