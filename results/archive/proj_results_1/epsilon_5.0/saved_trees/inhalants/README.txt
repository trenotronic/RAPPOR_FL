...
-------------------------------------------
Baseline F1:      0.0398
RAPPOR-only F1:   0.0237
RAPPOR + DP-seg:  0.0238

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0162
  • DPseg  - Baseline: -0.0161

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.0400
RAPPOR-only logreg F1:   0.0237
RAPPOR + DP-seg logreg:  0.0238

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0163
  • DPseg  - Baseline: -0.0162
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.2656
  DP-seg / Baseline: 0.0100
