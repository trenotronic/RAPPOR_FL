...
-------------------------------------------
Baseline F1:      0.2546
RAPPOR-only F1:   0.1632
RAPPOR + DP-seg:  0.1642

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0914
  • DPseg  - Baseline: -0.0904

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.2546
RAPPOR-only logreg F1:   0.1634
RAPPOR + DP-seg logreg:  0.1642

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0911
  • DPseg  - Baseline: -0.0904
