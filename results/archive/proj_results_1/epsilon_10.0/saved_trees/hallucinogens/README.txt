...
-------------------------------------------
Baseline F1:      0.1221
RAPPOR-only F1:   0.0666
RAPPOR + DP-seg:  0.0684

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0554
  • DPseg  - Baseline: -0.0536

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.1219
RAPPOR-only logreg F1:   0.0666
RAPPOR + DP-seg logreg:  0.0684

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0553
  • DPseg  - Baseline: -0.0534
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.1014
  DP-seg / Baseline: 0.0075
