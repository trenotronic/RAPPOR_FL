...
-------------------------------------------
Baseline F1:      0.1274
RAPPOR-only F1:   0.0340
RAPPOR + DP-seg:  0.1437

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0934
  • DPseg  - Baseline: 0.0163

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.2546
RAPPOR-only logreg F1:   0.1675
RAPPOR + DP-seg logreg:  0.1463

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0871
  • DPseg  - Baseline: -0.1083
