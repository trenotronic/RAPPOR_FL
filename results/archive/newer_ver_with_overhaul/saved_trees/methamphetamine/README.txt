...
-------------------------------------------
Baseline F1:      0.0191
RAPPOR-only F1:   0.0170
RAPPOR + DP-seg:  0.0169

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0022
  • DPseg  - Baseline: -0.0022

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.0443
RAPPOR-only logreg F1:   0.0164
RAPPOR + DP-seg logreg:  0.0170

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0280
  • DPseg  - Baseline: -0.0274
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.0261
  DP-seg / Baseline: 0.0054
