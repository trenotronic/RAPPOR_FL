...
-------------------------------------------
Baseline F1:      0.1134
RAPPOR-only F1:   0.0283
RAPPOR + DP-seg:  0.0812

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0851
  • DPseg  - Baseline: -0.0322

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.1230
RAPPOR-only logreg F1:   0.0779
RAPPOR + DP-seg logreg:  0.0760

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0452
  • DPseg  - Baseline: -0.0470
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.0345
  DP-seg / Baseline: 0.0086
