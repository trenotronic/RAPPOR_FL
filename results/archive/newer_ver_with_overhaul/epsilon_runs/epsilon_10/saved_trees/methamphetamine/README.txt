...
RAPPOR + DP-seg:  0.0168

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0021
  • DPseg  - Baseline: -0.0023

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.0443
RAPPOR-only logreg F1:   0.0169
RAPPOR + DP-seg logreg:  0.0170

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0274
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.1702
  DP-seg / Baseline: 0.0077
