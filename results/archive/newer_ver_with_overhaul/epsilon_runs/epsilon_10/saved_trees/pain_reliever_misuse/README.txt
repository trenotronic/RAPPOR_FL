...
-------------------------------------------
Baseline F1:      0.3727
RAPPOR-only F1:   0.3616
RAPPOR + DP-seg:  0.1561

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0111
  • DPseg  - Baseline: -0.2166

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.3909
RAPPOR-only logreg F1:   0.3066
RAPPOR + DP-seg logreg:  0.3012

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0843
  • DPseg  - Baseline: -0.0897
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.0797
  DP-seg / Baseline: 0.0056
