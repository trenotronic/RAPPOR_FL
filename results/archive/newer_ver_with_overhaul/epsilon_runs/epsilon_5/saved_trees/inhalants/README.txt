...
-------------------------------------------
Baseline F1:      0.0265
RAPPOR-only F1:   0.0246
RAPPOR + DP-seg:  0.0249

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0019
  • DPseg  - Baseline: -0.0017

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.0400
RAPPOR-only logreg F1:   0.0239
RAPPOR + DP-seg logreg:  0.0228

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0160
  • DPseg  - Baseline: -0.0172
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.2900
  DP-seg / Baseline: 0.0162
