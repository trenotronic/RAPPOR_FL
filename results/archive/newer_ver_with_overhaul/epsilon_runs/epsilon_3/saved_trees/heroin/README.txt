...
-------------------------------------------
Baseline F1:      0.0072
RAPPOR-only F1:   0.0043
RAPPOR + DP-seg:  0.0063

F1 deltas (tree):
  • RAPPOR - Baseline: -0.0028
  • DPseg  - Baseline: -0.0008

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.0161
RAPPOR-only logreg F1:   0.0064
RAPPOR + DP-seg logreg:  0.0066

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0097
  • DPseg  - Baseline: -0.0095
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.3389
  DP-seg / Baseline: 0.0168
