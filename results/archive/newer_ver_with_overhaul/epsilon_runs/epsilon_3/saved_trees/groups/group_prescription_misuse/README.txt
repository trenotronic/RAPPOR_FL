...
-------------------------------------------
Baseline F1:      0.4872
RAPPOR-only F1:   0.0176
RAPPOR + DP-seg:  0.1793

F1 deltas (tree):
  • RAPPOR - Baseline: -0.4697
  • DPseg  - Baseline: -0.3079

===========================================
MODEL PERFORMANCE (Logistic Regression, F1)
-------------------------------------------
Baseline logreg F1:      0.4786
RAPPOR-only logreg F1:   0.3937
RAPPOR + DP-seg logreg:  0.3731

F1 deltas (logreg):
  • RAPPOR - Baseline: -0.0849
  • DPseg  - Baseline: -0.1055
...
MI ratios (relative to baseline):
  RAPPOR / Baseline: 0.0714
  DP-seg / Baseline: 0.0044
